...
<p> Projeto Desenvolvido atravês de Estudo em Java, para Agendamento de Horários em uma Barbearia</p>
...
✔️ A aplicação deve cadastrar Servicos, Agenda no banco de dados <br>
✔️ A aplicação deve permitir a consulta de Servicos, Agenda<br>
✔️ A aplicação deve permitir a alteração de dados de Servicos, Agenda<br>
✔️ A aplicação deve permitir exclusão de um Servicos, Agenda <br>
